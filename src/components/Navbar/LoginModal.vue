...
<template>
  <div
    class="fixed inset-0 bg-slate-950 bg-opacity-75 flex items-center justify-center z-50"
  >
    <div class="min-h-screen py-6 flex flex-col justify-center sm:py-12">
      <div class="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        ></div>
        <div
          class="relative px-4 py-10 bg-yellow-100 shadow-lg sm:rounded-3xl sm:p-20"
        >
          <div class="max-w-md mx-auto">
            ...
            <h1 class="text-3xl font-semibold text-cyan-500 text-center mb-6">
            ...
            >
              <div class="relative">
                <input
                  v-model="email"
                  type="text"
                  class="peer placeholder-transparent h-10 w-full bg-yellow-100 border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-rose-600"
                  placeholder="Email"
                />
                <label
                  for="email"
              ...
              <div class="relative mt-6">
                <input
                  v-model="password"
                  type="password"
                  class="peer placeholder-transparent h-10 w-full border-b-2 bg-yellow-100 border-gray-300 text-gray-900 focus:outline-none focus:border-rose-600"
              ...
              <div class="relative mt-4">
                <button
                  type="submit"
                  class="bg-cyan-500 w-full text-white rounded-md px-4 py-2 hover:bg-teal-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-opacity-50"
                >
                  {{ isLogin ? "Login" : "Register" }}
                </button>
              </div>
            ...
            <div class="text-center mt-6">
              <p
                @click="toggleView"
                class="text-red-600 cursor-pointer hover:underline hover:decoration-cyan-600"
              >
                {{
                  isLogin

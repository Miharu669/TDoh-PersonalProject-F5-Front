  ...
  <section class="h-100 bg-gradient-to-r from-orange-700 via-black to-cyan-700 p-6 pb-20 shadow-2xl text-center text-white overflow-hidden relative">
    ...
    <div class="relative z-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-10 text-left max-w-4xl mx-auto text-xl">
        ...
        <div>
          <i class="fa-solid fa-circle-check text-yellow-400"></i> <strong>Points system:</strong> Every completed task rewards you with points. Track your progress and celebrate every win!
        </div>
        <div>
          <i class="fa-solid fa-circle-check text-yellow-400"></i> <strong>Pomodoro timer:</strong> Boost productivity with timed work sessions and breaks using our integrated Pomodoro feature.
        </div>
        <div>
          <i class="fa-solid fa-circle-check text-yellow-400"></i> <strong>Smart reminders:</strong> Never miss a deadline with personalized notifications and alarms.
        </div>
      </div>

      <p class="text-xl mt-8 mb-8 max-w-3xl mx-auto">
